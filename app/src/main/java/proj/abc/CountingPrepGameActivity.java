 ...
 */
public class CountingPrepGameActivity extends Activity {
  TextView tvColor;
  TextView tvQuestNum;
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.activity_counting_prep);
    ...
    switch ((int) (Math.random() * 2)) {
      case 0: //subtract
        ...
        int subtracted = (int) (Math.random() * (10)) + (correctNumber + 1);
        int subtractor = subtracted - correctNumber;

        tvColor.setText(subtracted+ " - "+subtractor);
        tvChoices.get(0).setText((correctNumber - 1) + "");
        tvChoices.get(1).setText(((int) (Math.random() * (10)) + (correctNumber + 1)) + "");
        break;
      case 1: //add

        int addend = (int) (Math.random() * correctNumber);
        int addum = correctNumber - addend;

        tvColor.setText(addum+ " + "+addend);
        tvChoices.get(0).setText((correctNumber + 1) + "");
