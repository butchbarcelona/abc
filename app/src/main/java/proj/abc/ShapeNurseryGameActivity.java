 ...
 */
public class ShapeNurseryGameActivity extends Activity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.activity_shape_nursery);
    ...
    imgBtn4 = (ImageButton) findViewById(R.id.img4);
    imgBtn5 = (ImageButton) findViewById(R.id.choice1);
    ...
    tvColor.setText("CHOOSE " + currColor.toUpperCase());
/*    imgMain.setImageResource(getColor(currColor));*/
    ...
    int[] rand = getRandomNot(0,colorBitmaps.size(),4);
